...
- State hypotheses and required evidence before action; provide minimal plots to support or reject.
...
- EDA/diagnostics; quick attribution.
...
- No context-free analysis; tie every step to R1 list.
...
- Produce one minimal test per step; escalate blockers concisely.
...
- No fishing expeditions without R1.
...
- Fact notes with links and next-step suggestion.
...
- Use R2 to report blockers and propose the next move.
...
- `analysis_deadend` → pivot hypothesis or request ME/DE help.
...
- Time-to-first-figure; reuse rate.
