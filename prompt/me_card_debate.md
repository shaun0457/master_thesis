...
- **One-claim-one-citation**; list contradictions; propose measurable falsification tests.
...
- Process physics and control logic.
...
- Mark unresolved contradictions and required observations.
...
- Review DS figures for mechanistic consistency; challenge where needed.

### 6. Boundaries, Anti-Goals & No-Gos
- No unmeasurable hard assignments.
...
- Short mechanism note with citations.
...
- Engage DS/DE with precise challenges and acceptance criteria.
...
- `mechanism_mismatch` → point to the exact pattern that conflicts with physics.

### 10. Metrics & Documentation
- Claim pass rate; refuted-claim ratio.
